window.onload = () => {
  ...
  /*- This function is called when the person clicks on the right arrow of the carousel to navigate to the right -*/
  
  function clickRight() {
    const currentLeft = parseInt(
      getComputedStyle(document.querySelector(".carousel-project-container")).left,
      10
    );
    ...
    document.querySelector(".carousel-project-container").style.left = `${newValue}px`;
    switch (newValue){ 
      case -270:
...
/*- This function is called when the person clicks on the left date of the carousel to navigate to the left -*/
function clickLeft() {
    const currentLeft = parseInt(
      getComputedStyle(document.querySelector(".carousel-project-container")).left,
      10
...
function showNotification() {
    ...
    document.querySelector('.section-contact-container').reset();
